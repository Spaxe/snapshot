...
module.exports=function(t,n,o){for(o=o||"0",t=t.toString();t.length<n;)t=o+t;return t};
...
},{"./support/isBuffer":8,"_process":7,"inherits":2}],10:[function(require,module,exports){
"use strict";function _interopRequireWildcard(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var a in t)Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e.default=t,e}function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}var _extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var a=arguments[e];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(t[n]=a[n])}return t},_slicedToArray=function(){function t(t,e){var a=[],n=!0,r=!1,i=void 0;try{for(var c,o=t[Symbol.iterator]();!(n=(c=o.next()).done)&&(a.push(c.value),!e||a.length!==e);n=!0);}catch(t){r=!0,i=t}finally{try{!n&&o.return&&o.return()}finally{if(r)throw i}}return a}return function(e,a){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return t(e,a);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_lodash=require("lodash"),_lodash2=_interopRequireDefault(_lodash),_d2=require("d3"),d3=_interopRequireWildcard(_d2),_markdown=require("markdown"),_markdown2=_interopRequireDefault(_markdown),_leftpad=require("leftpad"),_leftpad2=_interopRequireDefault(_leftpad),md=_markdown2.default.markdown,container=void 0,controls=void 0,config_cache=void 0,data_cache=void 0,explanation_cache=void 0,x_scale=void 0,y_scale=void 0,container_id="#decision-visualisation",width=500,height=200,margin={left:80,top:50,right:30,bottom:50},dispatch=d3.dispatch("toggle"),init=function(){dispatch.on("toggle",function(t,e){var a=document.querySelector(".control input:checked");if(draw(data_cache,a),metrics(data_cache,a),explanation_cache){d3.select(container_id+" .explanation .subtext-title").text(explanation_cache.columns[e+1]),d3.select(container_id+" .explanation .subtext").text(explanation_cache[0][t]);var n=d3.select(container_id+" .explanation .image");n.html(""),e>0&&n.append("img").attr("src",""+config_cache.explanation_pic_prefix+(0,_leftpad2.default)(e,3)+config_cache.explanation_pic_postfix)}}),d3.text(config_cache.general_intro_path,function(t){d3.select(container_id+" .description").append("p").html(md.toHTML(t))}),d3.select("#decision-title").text(config_cache.project_name),controls=d3.select(container_id+" .control");var t=d3.select(container_id+" .chart").append("svg").attr("width",width+margin.left+margin.right).attr("height",height+margin.top+margin.bottom).attr("aria-labelledby","title");t.append("desc").html(""+config_cache.project_name),t.append("title").html(config_cache.project_type+" visualisation"),container=t.append("g").attr("class","chart-area").attr("transform","translate("+margin.left+","+margin.top+")"),d3.csv(config_cache.data_path,prepare,function(t){data_cache=t,create_controls(t);var e=render_axes(t),a=_slicedToArray(e,2);x_scale=a[0],y_scale=a[1];var n=document.querySelector(".control input:checked");draw(data_cache,n),metrics(data_cache,n)}),d3.csv(config_cache.explanation_path,function(t){explanation_cache=t,dispatch.apply("toggle",void 0,[explanation_cache.columns[2],1])})},prepare=function(t){return t=_lodash2.default.mapValues(t,function(t){return Number(t)}),"year"===config_cache.x_label.toLowerCase()&&t[config_cache.x_label]&&(t=_extends({year:new Date(t[config_cache.x_label],0,1)},t),delete t[config_cache.x_label]),t},draw=function(t,e){if(t){var a=_lodash2.default.concat(e.value,config_cache.constant_limit),n=container.selectAll("path.line").data(a,function(t){return t});n.enter().append("path").attr("class",function(t){return t===config_cache.constant_limit?"line highlight":"line"}).attr("d",function(e){return d3.line().x(function(t){return x_scale(t.year)}).y(function(t){return y_scale(t[e])})(t)}),n.exit().remove();var r=container.selectAll("path.area").data(a,function(t){return t});r.enter().append("path").attr("class","area").attr("d",function(e){return d3.area().x(function(t){return x_scale(t.year)}).y0(function(t){return y_scale(t[config_cache.constant_limit])}).y1(function(t){return y_scale(Math.max(t[config_cache.constant_limit],t[e]))})(t)}),r.exit().remove()}},metrics=function(t,e){t&&"albatross"===config_cache.project_type&&!function(){var a=e.value,n=_lodash2.default.map(t,function(t){return t[config_cache.constant_limit]}),r=_lodash2.default.map(t,function(t){return t[a]}),i=_lodash2.default.filter(r,function(t,e){return t>n[e]}),c=_lodash2.default.sum(_lodash2.default.map(r,function(t,e){return Math.max(t-n[e],0)})),o=i.length>0?Math.round(c/i.length):0;d3.selectAll(container_id+" .metric p").remove(),d3.select(container_id+" .metric").append("p").html("In the <strong>"+a+'</strong> scenario, our model\n                    predicts the Albatross population will have\n                    <span class="highlight">'+i.length.toLocaleString()+"</span>\n                    years above the Management Reference Level."),d3.select(container_id+" .metric").append("p").html('In this path, there are an average of <span class="highlight">'+o.toLocaleString()+"</span>\n                    breeding pairs above the nominated Management Reference\n                    Level.")}()},create_controls=function(t){var e=_lodash2.default.remove(t.columns,function(t){return t!==config_cache.x_label});e.forEach(function(t,e){if(0!==e){var a=controls.append("input").attr("type","radio").attr("name","visualisation-option").attr("id","visualisation-option-"+e).attr("value",t).on("click",function(){dispatch.apply("toggle",this,[t,e])});controls.append("label").attr("class","toggle").attr("for","visualisation-option-"+e).text(t),1===e&&a.attr("checked","checked")}})},render_axes=function(t){var e=d3.extent(t,function(t){return t.year}),a=d3.scaleTime().domain(e).range([0,width]).nice(d3.timeYear,10),n=d3.axisBottom(a).ticks(d3.timeYear.every(20)),r=[0,1e4],i=d3.scaleLinear().domain(r).range([height,0]),c=d3.axisLeft(i).ticks(10),o=d3.axisTop(a).ticks(d3.timeYear.every(20)).tickSize(height).tickFormat(""),l=d3.axisRight(i).ticks(10).tickSize(width+10).tickFormat("");return container.append("g").attr("class","x grid").attr("transform","translate(0,"+height+")").call(o),container.append("g").attr("class","y grid").attr("transform","translate(-10,0)").call(l),container.append("g").attr("class","x axis").attr("transform","translate(0,"+height+")").call(n).append("text").attr("x",width/2).attr("y",30).text(config_cache.x_label),container.append("g").attr("class","y axis").attr("transform","translate(-10,0)").call(c).append("text").attr("x",0).attr("y",-15).text(config_cache.y_label),[a,i]};d3.json("data/config.json",function(t){config_cache=t,init()});
},{"d3":1,"leftpad":3,"lodash":4,"markdown":5}]},{},[10])
