...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{"default":t}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.boundaries=exports.attributes=exports.variables=exports.dimensions=exports.values=exports.constructUrl=exports.catalog=void 0;var _slicedToArray=function(){function t(t,e){var a=[],n=!0,r=!1,i=void 0;try{for(var o,u=t[Symbol.iterator]();!(n=(o=u.next()).done)&&(a.push(o.value),!e||a.length!==e);n=!0);}catch(s){r=!0,i=s}finally{try{!n&&u["return"]&&u["return"]()}finally{if(r)throw i}}return a}return function(e,a){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return t(e,a);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_moment=require("moment"),_moment2=_interopRequireDefault(_moment),_util=require("./util"),_util2=_interopRequireDefault(_util),catalog=exports.catalog=function(t,e,a){_util2["default"].loadJSON(e,function(t,e){a(t,e)})},constructUrl=exports.constructUrl=function(t,e,a){var n=function(t,e){var a=e?e.map(function(t){var e=_slicedToArray(t,3),a=e[0],n=e[1],r=e[2];return"["+a+":"+n+":"+r+"]"}).join(""):"";return""+t+a};if(Array.isArray(e))var r=e.map(function(t,e){return n(t,a[e])}),i=t+".ijsn?"+r.join(",");else var i=t+".ijsn?"+n(e,a);return i},values=exports.values=function(t,e,a,n){var r=constructUrl(t,e,a);_util2["default"].loadJSON(r,function(t,e){n(t,e)})},dimensions=exports.dimensions=function(t,e){var a=t+".ijsn";_util2["default"].loadJSON(a,function(t,a){e(t,a)})},variables=exports.variables=function(t,e){var a=t.replace("/opendap/","/opendap/w10n/")+"/?output=json";_util2["default"].loadJSON(a,function(t,a){e(t,a)})},attributes=exports.attributes=function(t,e){variables(t,function(t,a){t&&e(t);var n={};a.attributes.forEach(function(t){"NC_GLOBAL"===t.name&&t.attributes.forEach(function(t){var e=1===t.value.length?t.value[0]:t.value;n[t.name]=e})}),e(null,n)})},boundaries=exports.boundaries=function(t,e){variables(t,function(a,n){a&&e(a);var r=[0,0,0];n.leaves.forEach(function(t){"time"===t.name?r[0]=t.shape[0]:"lat"===t.name||"y"===t.name?r[1]=t.shape[0]:"lon"!==t.name&&"x"!==t.name||(r[2]=t.shape[0])});var i=["WQ_data","WQ_medians","WQ_minvals","WQ_maxvals"];values(t,i,[[[0,1,r[0]-1],[0,r[1]-1,r[1]-1],[0,r[2]-1,r[2]-1]],[],[],[]],function(t,a){t&&e(t);var n=a.WQ_data;n.shapes=r,n.time=n.time.map(function(t){return _moment2["default"].unix(t)}),n.startDate=n.time[0],n.variable="WQ_data",n.medians=a.WQ_medians.WQ_medians,n.minvals=a.WQ_minvals.WQ_minvals,n.maxvals=a.WQ_maxvals.WQ_maxvals,n.x||(n.x=n.lon),n.lon||(n.lon=n.x),n.y||(n.y=n.lat),n.lat||(n.lat=n.y),n.dates||(n.dates=n.time),e(null,n)})})};module.exports={catalog:catalog,dimensions:dimensions,constructUrl:constructUrl,variables:variables,values:values,attributes:attributes,boundaries:boundaries};
